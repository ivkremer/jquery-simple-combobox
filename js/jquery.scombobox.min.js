...
this.data(c+"-init",!1));return this},clear:function(){this.children("select").empty();this.children(b+n).empty().width("");this.children(b+k).removeClass(c+v);this.children(b+q).removeClass(c+q+v);return this},data:function(a){if(0==arguments.length)return this.data(c).data;this.data(c).data=a;return this},disabled:function(a){var e=this.data(c).mode;if(0==arguments.length)return"checkboxes"==e?this.hasClass(c+"-disabled"):this.children(b+k).prop("disabled");a=!!a;this.children(b+k).prop("disabled",
a);a?(this.addClass(c+"-disabled"),this.children(b+q+", "+b+s).hide()):(this.removeClass(c+"-disabled"),this.children(b+q+", "+b+s).show());return this},tabindex:function(a){var c=this.find(b+k);if(0==arguments.length)return c.attr("tabindex");c.attr("tabindex",a);return this},options:function(a){if(0==arguments.length)return this.data(c);d.extend(!0,this.data(c),G(a));return this},val:function(a){var e=this.data(c).mode;if(0==arguments.length)return"default"==e?this.find(b+k).is(":disabled")?"":
this.find(b+r).val():"checkboxes"==e?JSON.parse(this.find(b+r).val()||"[]"):null;if("default"==e){var g=d(this),e=g.children("select"),h=g.children(b+r),f=g.children(b+k);0==e.children('[value="'+a+'"]').length?(e.children().prop("selected",!1),h.val(""),f.val("")):(e.val(a).change(),g.find(b+r).val(a))}else if("checkboxes"==e){for(var e=d(this).find(b+n+" p"),h=d(this).children(b+r),f=[],l=0;l<e.length;l++){var m=e.eq(l),q=a.indexOf(m.data("value"));0<=a.indexOf(m.data("value"))?(g=m.find(":checkbox").prop("checked",
!0),f.push(a[q])):m.find(":checkbox").prop("checked",!1)}d(this).children("select").val(a);g.trigger(c+"-chupdate",[!0]);h.val(JSON.stringify(f))}return this},open:function(){t.call(this.children(b+n),"down");return this},close:function(){t.call(this.children(b+n),"up");return this},change:function(a,c){return w.call(this,"change",this.children(b+r),a,c)},focus:function(a,c){return w.call(this,"focus",this.children(b+k),a,c)},blur:function(a,c){return w.call(this,"blur",this.children(b+k),a,c)},keyup:function(a,
c){return w.call(this,"keyup",this.children(b+k),a,c)},keydown:function(a,c){return w.call(this,"keydown",this.children(b+k),a,c)},keypress:function(a,c){return w.call(this,"keypress",this.children(b+k),a,c)},click:function(a,c){return w.call(this,"click",this.children(b+k),a,c)},mousedown:function(a,c){return w.call(this,"mousedown",this.children(b+k),a,c)},clickDropdown:function(a,c){return w.call(this,"click",this.children(b+s),a,c)},invalid:function(a){0==arguments.length?this.children(b+k).hasClass(c+
v):this.children(b+k).addClass(c+v);return this},toSelect:function(){var a=this.children("select").insertAfter(this);this.data(c).reassignId&&a.attr("id",this.attr("id"));this.remove();return a},displayDropdown:function(a){arguments.length?a?this.children(b+s+", "+b+q).show():this.children(b+s+", "+b+q).hide():this.data(c).showDropdown?this.children(b+s+", "+b+q).show():this.children(b+s+", "+b+q).hide();return this}};d.fn[c]=function(a){if("string"==typeof a){if(0==this.length)return this;null==
...
easing:"swing"},listMaxWidth:window.screen.width/2,wrap:!0,maxHeight:"",fillOnArrowPress:!0,fillOnBlur:!1,fillOnTab:!0,showDropDown:!0,callback:{func:d.noop,args:[]},beforeOpen:d.noop,beforeClose:d.noop,afterOpen:d.noop,afterClose:d.noop,autoLoad:d.noop,loopScrolling:!0};d.fn[c].extendDefaults=function(a){d.extend(!0,d.fn[c].defaults,a)}})(jQuery,document);