...
"down");else{if(0==g.length)a=k.is(":visible:not(.scombobox-separator, .scombobox-header)")?k.addClass("scombobox-hovered"):k.nextAll(":visible:not(.scombobox-separator, .scombobox-header)").first().addClass("scombobox-hovered");else{if(!p&&!g.nextAll(":visible:not(.scombobox-separator, .scombobox-header)").first().length)return;a=g.removeClass("scombobox-hovered").nextAll(":visible:not(.scombobox-separator, .scombobox-header)").first().addClass("scombobox-hovered");0==a.length&&(a=k.is(":visible")?
k.addClass("scombobox-hovered"):k.nextAll(":visible:not(.scombobox-separator, .scombobox-header)").first().addClass("scombobox-hovered"));0==a.length&&(a=k);k=a.position().top-e.position().top;g=a.outerHeight();k+6*g>e.height()?k+6*g-e.height()>1.5*g?e.scrollTop(n+k):e.scrollTop(n+g):0>k&&e.scrollTop(n- -k)}w&&(this.value=a.find(".scombobox-mainspan").text(),c.children(".scombobox-display").data("fillonarrow",!0))}else 38==a.which?e.is(":visible")&&(p||g.prevAll(":visible:not(.scombobox-separator, .scombobox-header)").first().length)&&
...
b.fillOnBlur?(c=e.children(".scombobox-hovered:visible"),0==c.length&&(c=e.children(":visible:first")),c.click()):(e.children(".scombobox-hovered").click(),"default"==b.mode&&m.call(e,"up")):27==a.which?(b.blurOnEscape?d(this).blur():d(this),e.is(":visible")&&(m.call(e,"up"),a.stopPropagation())):9==a.which&&b.fillOnTab&&l&&(e=e.children(".scombobox-hovered"),e.length&&e.click())}}});this.on("change","select",function(a,b){var c=d(this).closest(".scombobox"),g=d("option:selected",this).text();c.children(".scombobox-display").val(g).data("value",
g);g=c.children(".scombobox-value");g.data("changed")?g.data("changed",!1):b?(A.call(c),g.change()):(g.change(),m.call(c.children(".scombobox-list"),"up"))});this.on("scombobox-chupdate",".scombobox-list p :checkbox",function(a,b){b&&(a.stopPropagation(),x.call(d(this).parent(),a,!0))});this.on("click",".scombobox-list p",function(b){clearTimeout(r);b.stopPropagation();if(!d(this).is(".scombobox-separator, .scombobox-header")){a.children(".scombobox-invalid").removeClass("scombobox-invalid");a.children(".scombobox-dropdown-background").removeClass("scombobox-dropdown-background-invalid");
var c=d(this),e=c.parent(),g=e.children().index(this);"checkboxes"==a.data("scombobox").mode?x.call(this,b):(b=e.closest(".scombobox").children("select"),b.children("option").eq(g).prop("selected",!0),b.siblings(".scombobox-value").val(b.val()),b.change(),m.call(c.parent(),"up"),c.addClass("scombobox-hovered").siblings().removeClass("scombobox-hovered"))}});this.on("blur",".scombobox-display",function(c){var f=d(this);c=d(c.relatedTarget).closest(".scombobox");if(!(0<c.length&&c[0]===f.closest(".scombobox")[0])){r=
setTimeout(function(){var b=d(this);a.data("scombobox");this===v.activeElement&&b.data("silentfocus",!0);b.data("fillonarrow",!1);m.call(b.closest(".scombobox").children(".scombobox-list"),"up")}.bind(this),200);var e=f.val().trim();c=f.siblings(".scombobox-value");var g=c.val();if(e){var k;f.siblings("select").find("option").each(function(){b.filterIgnoreCase?e.toLowerCase()==d(this).text().trim().toLowerCase()&&(k=this.value):e==d(this).text().trim()&&(k=this.value)});k?c.val(k):c.val(b.invalidAsValue?
e:"")}else c.val("");g!==c.val()&&c.change().data("changed",!0)}});this.on("focus",".scombobox-display",function(){if(d(this).data("silentfocus"))d(this).data("silentfocus",!1);else{if(!this.value.trim())(a.data("scombobox").expandOnFocus||d(this).data("expandfocus"))&&d(this).keyup();else if(a.data("scombobox").expandOnFocusWithValue||d(this).data("expandfocus"))if(a.scombobox("val")){var b=a.children(".scombobox-list");b.children().show();m.call(b,"down")}else d(this).keyup();d(this).data("expandfocus",
!1)}});this.on("click",".scombobox-display-div",function(){a.data("scombobox").disabled||m.call(d(this).siblings(".scombobox-list"),"down")});this.on("click",".scombobox-display",function(a){var b=d(this).closest(".scombobox")[0];d(".scombobox").each(function(){this!=b&&d(this).scombobox("close")});a.stopPropagation()});this.on("click",".scombobox-dropdown-arrow",function(a){clearTimeout(r);a.stopPropagation();a=d(this).closest(".scombobox");var b=a.children(".scombobox-list");b.is(":visible")?(m.call(b,
"up"),a.children(".scombobox-display").data("silentfocus",!0).focus()):a.children(".scombobox-display").data("expandfocus",!0).focus()});this.on("click",".scombobox-display-div-item-remove",function(c){clearTimeout(r);c.stopPropagation();c=d(this);var f=c.parent();a.children(".scombobox-list").children("p").eq(c.data("index")).find(":checkbox").prop("checked",!1);f.fadeOut(b.animation.duration);c.closest(".scombobox").children("select").trigger("change",[!0])});b.autoLoad!=d.noop&&d(".scombobox-list",
...
b.eq(e),k=a.indexOf(g.data("value")),0<=a.indexOf(g.data("value"))?(h=g.find(":checkbox").prop("checked",!0),f.push(a[k])):g.find(":checkbox").prop("checked",!1);d(this).children("select").val(a);h.trigger("scombobox-chupdate",[!0]);c.val(JSON.stringify(f))}return this},open:function(){m.call(this.children(".scombobox-list"),"down");return this},close:function(){m.call(this.children(".scombobox-list"),"up");return this},change:function(a,b){return l.call(this,"change",this.children(".scombobox-value"),
...
this.children(".scombobox-dropdown-arrow, .scombobox-dropdown-background").hide():this.data("scombobox").showDropdown?this.children(".scombobox-dropdown-arrow, .scombobox-dropdown-background").show():this.children(".scombobox-dropdown-arrow, .scombobox-dropdown-background").hide();return this}},r;d.fn.scombobox=function(a){if("string"==typeof a){this.length||d.error("Calling scombobox."+a+"() method on empty collection");null==this.data("scombobox-init")&&d.error("Calling scombobox."+a+"() method prior to initialization");
var b=t[a];b||d.error("No such method: "+a+" in jQuery.scombobox()")}else if(0<=["object","undefined"].indexOf(typeof a))var c=d.extend(!0,{},d.fn.scombobox.defaults,u(a));else return d.error("Incorrect usage"),this;return b?b.apply(this,Array.prototype.slice.call(arguments,1)):this.each(function(){var a=d(this);a.is("select, div")?(a.is("select")&&(a.wrap("<div />"),c.reassignId&&a.parent().attr("id",a.attr("id")),a=a.parent()),a.data("scombobox",d.extend(!0,{},c)),t.init.apply(a)):console.warn("target element is incorrect: ",
this)})};d.fn.scombobox.defaults={data:null,empty:!1,disabled:!1,sort:!0,sortAsc:!0,removeDuplicates:!0,fullMatch:!1,highlight:null,filterIgnoreCase:!0,filterIgnoreAccents:!1,filterDelay:0,hideSeparatorsOnSearch:!1,expandOnFocus:!0,expandOnFocusWithValue:!0,tabindex:null,forbidInvalid:!1,invalidAsValue:!1,highlightInvalid:null,reassignId:!0,mode:"default",pMarkup:'<span class="scombobox-mainspan">${text}</span> <span>${additional}</span>',pFillFunc:function(a,b){return d("<p />").html(b.pMarkup.replace("${text}",
